...
function Library:MakeWindow(config)
    ...
    local SettingsBtn = Create("ImageButton", {
        ...
        Image = "rbxassetid://12030232490",
        ImageColor3 = Color3.fromRGB(150, 150, 150)
    })
    
    local ForceSettingsPanel = Create("Frame", {
        Parent = ScreenGui,
    ...
    SettingsBtn.MouseButton1Click:Connect(function()
        ...
        if panelOpen then
            ...
            Tween(ForceSettingsPanel, 0.2, {Size = UDim2.new(0, 220, 0, panelLayout.AbsoluteContentSize.Y + 20)})
        else
    ...
    function Window:MakeTab(tabConfig)
        ...
        function TabObj:AddSection(secConfig)
            ...
            function SectionObj:AddButton(cfg, cbArg)
                ...
                local desc = type(cfg) == "table" and (cfg.Dec or cfg.Description or (cfg[2] and type(cfg[2]) == "string" and cfg[2])) or nil
